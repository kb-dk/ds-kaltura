...
public class DsKalturaClient {
    ...
    /*
    Kaltura enforces a hard limit of 10,000 results total per query regardless of your page size.
    So if you request pages of 500 entries each,
    after 20 pages (20 × 500 = 10,000 entries),
    the API stops returning further results—even if more entries exist that match your filter
     */
